...
def call_openai(prompt):
    ...
    try:
        messages = [
            {"role": "system", "content": "You are an AI trained to help with updating README files based on commit messages an code files"},
            {"role": "user", "content": prompt}
        ]

        response = client.invole(input=messages)
...
def update_readme_and_create_pr(repo, updated_readme, readme_sha):
    ...
    pr_body = "This PR was automatically generated by an AI to update the README based on recent code changes."
